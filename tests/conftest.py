...
Provides test client and data isolation for all tests.
"""
...
def reset_activities():
    ...
    This ensures test isolation by restoring the original activities data.
    """
    original_activities = {
        "Chess Club": {
...
def sample_email():
    ...
    return "newtestuser@mergington.edu"